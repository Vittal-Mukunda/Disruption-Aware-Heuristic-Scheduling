...
CHECKS = [
 ...
 ("R1.4c ATC calibrated twice",
  ["ATC is calibrated, not assumed", "k^\\star_{\\text{standalone}}", "k^\\star_{\\text{portfolio}}"],
  ["experiments/calibrate_rules.py"], ["portfolio", "standalone"]),
 ("R1.4d pool expanded + screening table",
  ["Screening is by marginal contribution", "COVERT"],
  ["experiments/calibrate_rules.py"], ["screen"]),
 ("R1.4e complementarity over state space",
  ["win rate over a grid of the two state dimensions", "diversity_state_grid"],
