...
CHECKS = [
 ...
 ("R1.1b warehouse lit review expanded",
  ["## Dispatching rules and data-centric control in warehousing", "boysen2019warehousing"], [], []),
 ...
 ("R1.1d perishability binds? measured",
  ["## Does perishability bind", "expiry-pivotal"],
 ...
 ("R1.3a feature provenance + correlation/VIF",
  ["Appendix A. State features, their provenance", "## Redundancy analysis", "variance inflation"],
 ...
 ("R1.4a/b pool motivated; FIFO justified",
  ["## The rule pool", "zero-information control"], [], []),
 ...
 ("R1.6a WSPT/FIFO anomalies explained",
  ["Two modelling defects", "Cause 1", "Cause 2"],
  ["simulation/warehouse_env.py"], []),
 ("R1.6b RL sensitivity + coverage",
  ["Sensitivity analysis", "gap_closed_fraction", "**Action coverage.**"],
 ...
 ("R2.5 model misspecification",
  ["## Model misspecification", "labelling in one world"],
 ...
 ("R3.6 limitations expanded",
  ["## Shared-simulator circularity", "## A small heuristic pool",
   "## A single warehouse setting", "## No online adaptation after deployment"], [], []),
